...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    ...
    <form action="../edit_submit/{{$TodoArr_name->id}}">
            <input type="text" name="name" value="{{$TodoArr_name->name}}" class='form-control'style="margin-top:50px;margin-left:350px;width:420px;">
            <br></br>
            <label >Choose a priority :</label>
            <select name="priority" class='form-control'style="margin-left:350px;width:420px;">
               @if($TodoArr_name->priority == 'high')
                    
                <option value="high">High</option>
                <option value="medium">Medium</option>
                <option value="low">Low</option>
                @endif
                @if($TodoArr_name->priority == 'medium')
                
                <option value="medium">Medium</option>
                <option value="high">High</option>
                <option value="low">Low</option>
                @endif
                @if($TodoArr_name->priority == 'low')
            ...
            <br></br>
            <input type="submit">
            <button style="margin-left:50px;"><a href="/">View To Do list</a></button>
    </form>
    </div>
